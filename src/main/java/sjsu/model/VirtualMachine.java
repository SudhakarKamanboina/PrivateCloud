...
public class VirtualMachine {
    ...
    public VirtualMachine(String name, String powerState, String bootTime, String guestOSName, String guestID, String version, List<String> networks, List<String> hosts, int guestMemoryUsage, int hostMemoryUsage, int overallCPUUsage, List<String> datastores, String ip) {
        this.name = name;
    ...
    public static VirtualMachine instance(com.vmware.vim25.mo.VirtualMachine virtualMachine) {
        ...
        if(datastores1!=null){
            ...
            List<Datastore> lst = Arrays.asList(datastores1);
            for(Datastore store: lst)
            {
                dataStoreNames.add(store.getName());
            }
        }
        return new VirtualMachine(vmachineName,vmri.getPowerState().name(), bootTime, guestFullName, guestId, version1,networknames,hosts, guestMemoryUsage1, hostMemoryUsage1, overallCpuUsage,dataStoreNames,virtualMachine.getGuest().getIpAddress());
    }
}
